...
/**
 * S05 — Q6, l'expérience. « Pourquoi les méthodes {@code accept} sont-elles
 * nécessaires ? »
 *
 ...
 *
 * <pre>mvn -q compile exec:java -Dexec.mainClass=cpoo2.s04.arbre.SurchargeDemo</pre>
 *
 * <p>ou simplement, depuis {@code target/classes} :
 * <pre>java -cp target/classes cpoo2.s04.arbre.SurchargeDemo</pre>
 *
